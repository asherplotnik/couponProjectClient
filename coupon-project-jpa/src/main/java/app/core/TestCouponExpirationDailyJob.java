...
public class TestCouponExpirationDailyJob {
	...
	public static void main(String[] args) {
		...
		try {
			...
			CompanyService companyService = (CompanyService)loginManager.login("comp1@email3", "333", 1);

			Coupon coupon = new Coupon(3, "newnewnew", "newnewnew", LocalDate.of(2020, 1, 1), LocalDate.of(2020, 1, 4), 25, 25.58, "age8");
