...
//				Coupon cp2 = new Coupon(0, 2, "coupon1", "coupon2desc", LocalDate.of(2021, 8, 1),
//						LocalDate.of(2021, 8, 10), 15, 15.5, "image2");
//				Coupon cp3 = new Coupon(0, 1, "coupon3", "coupon3desc", LocalDate.of(2021, 7, 1),
//						LocalDate.of(2021, 7, 10), 14, 14.5, "image3");
//				Coupon cp4 = new Coupon(0, 2, "coupon4", "coupon4desc", LocalDate.of(2021, 6, 1),
//						LocalDate.of(2021, 6, 10), 13, 13.5, "image4");
//				Coupon cp5 = new Coupon(0, 1, "coupon5", "coupon5desc", LocalDate.of(2021, 7, 1),
//						LocalDate.of(2021, 5, 10), 12, 12.5, "image5");
//				Coupon cp6 = new Coupon(0, 2, "coupon6", "coupon6desc", LocalDate.of(2021, 4, 1),
//						LocalDate.of(2021, 4, 10), 11, 11.5, "image6");
//
//				cm1.addCoupon(cp1);
//				cm1.addCoupon(cp2);
//				cm2.addCoupon(cp3);
...
//
//				Customer cu1 = new Customer(0, "cust1", "cust1f", "cust1@email", "111");
//				Customer cu2 = new Customer(0, "cust2", "cust2f", "cust2@email", "222");
//				Customer cu3 = new Customer(0, "cust3", "cust3f", "cust3@email", "333");
//
